...
import org.springframework.security.web.csrf.CookieCsrfTokenRepository; // IMPORT AÑADIDO
...
public class ProjectConfig implements WebMvcConfigurer {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        ).csrf(csrf -> csrf // SOLUCIÓN 1 AÑADIDA - Cookie CSRF Token Repository
    ...
    // ✅ CONFIGURACIÓN DE FIREBASE AGREGADA - BEAN DE STORAGE
    @Bean
    public Storage storage() throws IOException {
        // Configuración básica - esto hará que funcione
